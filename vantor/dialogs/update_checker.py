"""
Update Checker Dialog for Vantor Plugin
...
GITHUB_REPO = "opengeos/qgis-vantor-plugin"
GITHUB_BRANCH = "main"
PLUGIN_PATH = "vantor"
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        temp_dir = None
        try:
            temp_dir = tempfile.mkdtemp(prefix="vantor_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "vantor_plugin.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "vantor_plugin.py"))
                ...
                if os.path.exists(backup_dir) and is_valid_plugin_dir(backup_dir):
                    ...
                    self.error.emit(
                        "Backup missing or invalid, cannot restore "
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("Vantor Plugin Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("Vantor Plugin Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"Vantor has been updated to version {self.latest_version}.\n\n"
